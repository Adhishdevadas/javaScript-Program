...
console.log(getPlayerItems(player1));



var showItem = function(player, itemNumber) {
    if (itemNumber >= 1 && itemNumber <= player.items.length) {
        var item = player.items[itemNumber - 1];
        console.log("Item " + itemNumber + ": " + item);
    } else {
...
var addItem = function(player, itemTitle) {
    ...
    console.log(itemTitle + " has been added to " + player.name + "'s items.");
};
